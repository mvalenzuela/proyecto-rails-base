...
class EnrollmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post enrollments_url, params: { enrollment: { course_id: @enrollment.course_id, person_id: @enrollment.person_id } }
    end
  ...
  test "should update enrollment" do
    patch enrollment_url(@enrollment), params: { enrollment: { course_id: @enrollment.course_id, person_id: @enrollment.person_id } }
